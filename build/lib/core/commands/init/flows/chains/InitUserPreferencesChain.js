...
exports.InitUserPreferencesChain = void 0;
...
var InitUserPreferencesChain = /** @class */ (function (_super) {
    __extends(InitUserPreferencesChain, _super);
    function InitUserPreferencesChain() {
        var _this = _super.call(this) || this;
        _this.handlers = [new UserEntrypoint_handler_1.UserEntrypointHandler(), new UserGitIgnore_handler_1.UserGitIgnoreHandler()];
        return _this;
    }
    return InitUserPreferencesChain;
}(SequentialChain_1.SequentialChain));
exports.InitUserPreferencesChain = InitUserPreferencesChain;
